    ...
    return (
      <div className="my-1 px-2 flex flex justify-between items-center">
        <div
          ...
          class="mr-1 bg-gray-100 text-gray-300 rounded w-4 p-1 text-center"
        >
          //
        </div>
        <div
        ...
        >
          <div class={`bg-gray-100 text-gray-400 rounded w-8 p-1 text-center`}>
            <Icon icon={icon} color="#dddddd" size={14} />
          </div>
          <div class={`pl-2 flex-1 text-xs text-gray-300`}>{text}</div>
        </div>
        <div
  ...
  return (
    <div className="my-1 px-2 flex flex justify-between items-center">
      <div
        ...
        class="mr-1 bg-gray-200 text-gray-600 rounded w-4 p-1 text-center"
      >
        //
      </div>
      <div
        onClick={() => props.handler({ yo: "edit", directives: [[99]] })}
        class={`flex-1 flex jusitfy-between items-center rounded bg-${stepColor}-100`}
      >
        <div
          class={`bg-${stepColor}-300 text-${stepColor}-800 rounded w-8 p-1 text-center`}
        >
          <Icon icon={icon} color={color1} size={14} />
        </div>
        <div class={`pl-2 flex-1 text-xs text-${stepColor}-800`}>{text}</div>
      </div>
      <div
        onClick={() =>
          props.handler({
      ...
      <div
        ...
        class="ml-2 bg-red-100 text-red-800 rounded w-8 p-1 text-center"
      >
