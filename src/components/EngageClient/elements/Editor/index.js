...
export default class FluentEditor extends Component {
  ...
  onChange(source) {
    ...
    ctxout[this.props.args.retctx] = source;
          ...
          <div class="flex-1">
            <div class="bg-white px-2 max-w-7xl">
              <Editor
                ...
                highlight={
                  fluent ? source => highlight(source) : source => source
                }
